...
Development of GLM-lasso-based candidate strategy models.
...
```{r}
roc_lasso_porsm <- roc_porsm
roc_lasso_horsm <- roc_horsm
save(roc_lasso_porsm, roc_lasso_horsm, 
     file = "roc_lasso.RData")
```
